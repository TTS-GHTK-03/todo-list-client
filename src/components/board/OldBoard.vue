<template>
    <div class="mt-20 px-10 py-0 ml-10">
      <div class="h-[40px] flex justify-between items-center">
        <div class="block">
          <span class="font-ui text-lg text-gray-400 block">Projects / name</span>
          <span class="font-ui text-2xl font-semibold opacity-80 block">All Sprint</span>
        </div>
        <div class="flex">
          <button class="h-[32px] bg-blue-600 text-white hover:bg-blue-700 px-3 mr-4 rounded">
            Complete sprint
          </button>
          <button class="h-[32px] bg-gray-200 text-black hover:bg-gray-300 px-3 rounded">
            Edit sprint
          </button>
        </div>
      </div>
      ...
      <div class="overflow-x overflow-y">
        <div class="scroll-container">
          <div class="mt-6 flex" style="
      
              --board-scroll-element-height: 80;
              --board-scroll-element-width: 0;
            ">
            <!-- select 1  -->
            <div class="bg-gray-100 py-1.5 z-10">
              <div class="bg-gray-100" style="
                  ...
                  z-index: 9999;
                ">
                <div class="h-10 flex items-center ml-4">
                  <span class="uppercase">TO DO</span>
                </div>
              </div>
              <ul>
                <li>
                  <item-task text="This is a long text that will be truncated if it exceeds the width of the container"
                    img-alt="Task"
                    img-src="https://tag111.atlassian.net/rest/api/2/universal_avatar/view/type/issuetype/avatar/10318?size=medium"
                    key-text="Key This is a long text that will be truncated" tooltip-title="Image"
                    button-img-src="https://secure.gravatar.com/avatar/b135b1cb057c7e8230e8d0d5a3eba119?d=https%3A%2F%2Favatar-management--avatars.us-west-2.prod.public.atl-paas.net%2Finitials%2FLH-4.png" />
                </li>
                <li>
                  <item-task text="This is a long text that will be truncated if it exceeds the width of the container"
                    img-alt="Task"
            ...
            <!--  -->
            <!-- select 2 -->
            <div class="bg-gray-100 py-1.5 ml-4 z-10">
              <div class="bg-gray-100" style="
                  position: -webkit-sticky;
                  position: sticky;
                  top: 0;
  ...
  import ItemTask from "../shared/ItemTask/ItemTask.vue";
