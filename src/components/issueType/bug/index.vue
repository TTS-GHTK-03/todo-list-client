<template>
    ...
    <div class="p-4 flex flex-col mx-72">
        ...
        <div class="flex items-center justify-between mt-24 ">
                ...
                <div class="flex items-center justify-between ml-2 relative flex-grow h-11 transition-all duration-300">
                    ...
                    <div v-else class="relative flex items-center w-full">
                        <input v-model="title" spellcheck="false" type="text"
                            ...
                            @blur="stopEditing" ref="titleInput"
            ...
            <!-- Phần bên phải -->
            <div
                class="hover:bg-gray-100 hover:bg-opacity-80 rounded-lg cursor-pointer mb-1 mr-2 h-10 w-10 flex items-center justify-center" @click="openModal">
                <i class="fa-solid fa-plus"></i>
                <AddLabelModal :visible="isModalVisible" @update:visible="isModalVisible = $event" />
            </div>
        ...
        <div class="flex items-center justify-between mt-4 ">
            ...
            <div v-else class="relative flex items-center w-full">
                <input v-model="description" spellcheck="false" type="text"
                    ...
                    style="border-color: #3b82f6 !important; outline: none !important;" />
                <div class="absolute right-0 top-full mt-1 flex space-x-1">
                    <button @click="confirmEdit('description')" class="h-8 w-8 rounded border bg-white hover:bg-gray-200 shadow">
                        <i class="fa-solid fa-check"></i>
                    </button>
                    <button @click="cancelEdit('description')" class="h-8 w-8 rounded border bg-white hover:bg-gray-200 shadow">
                        <i class="fa-solid fa-xmark"></i>
                    </button>
                </div>
            </div>
