<template>
  <div
    class="container mx-auto flex flex-col justify-center items-center min-h-screen"
  >
    ...
    >
      ...
      <form @submit.prevent="submitForm" class="w-full">
        <div class="form-group mb-4">
          <label
            for="name"
            class="block text-sm font-medium text-text-dark-thin"
          ...
          >
            ...
            <span class="icon">
              ...
              >
                <path
                  fill-rule="evenodd"
                  d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-8h2V5h-2v5zm0 4h2v-2h-2v2z"
                  clip-rule="evenodd"
                />
              </svg>
            </span>
        ...
        <div class="flex justify-end space-x-2">
          ...
          <button
            type="submit"
            class="px-4 py-2 bg-[#0052CC] text-white rounded hover:bg-[#0747A6]"
          >
            Next
          </button>
        </div>
...
.back-button {
  ...
  font-weight: 600; /* Increase the font weight to make it bolder */
}
