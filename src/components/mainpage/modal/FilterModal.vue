    ...
    <div v-if="isVisible" class="fixed inset-x-0 flex items-start justify-center bg-opacity-50 transition-opacity duration-300 ease-in-out ">
      <div class="bg-white w-[320px] shadow-lg border rounded border-gray-500 border-opacity-20 p-0">
        ...
        <div class="mb-4 w-full mt-4 flex flex-col items-center text-center text-[#172b4d]">
          ...
          <span class="text-sm font-normal mx-4 mt-2 font-ui">Search for issues across all projects and save them as filters.</span>
          <span class="text-sm font-normal font-ui text-[#0c66e4] hover:underline cursor-pointer">Learn more</span>
