<template>
  ...
  >
    <div
      class="bg-white w-[320px] shadow-lg border rounded border-gray-500 border-opacity-20 p-0"
    >
      <!-- Section 1 -->
      <div class="mb-4 w-full mt-2">
        <span class="text-xs my-4 text-[#44546F] pl-4">RECENT</span>
        <button class="w-full mt-2">
          <div
            class="flex px-4 py-2 h-[52px] bg-white hover:bg-gray-200 transition-colors duration-200 items-center"
          >
