            ...
            <div v-if="showDropdown" ref="dropdownMenu"
                ...
                <div class="my-2 text-[11px] font-semibold font-apple">
                    <div @click="selectStatus('TO DO')" :class="itemClasses('TO DO')"
                        class="h-[28px] flex items-center pl-4 cursor-pointer">
            ...
            <div class="flex items-center justify-between min-w-[150px]">
                ...
                <div v-else class="relative ml-10 select-none ">
                    <input 
                        v-model="inputValue"
                        type="number" 
                        class="w-[80px] border-2 border-gray-500 rounded p-2 h-8  relative text-xs"
                        min="0" 
                        max="5"
                        @input="validateInput"/>
...
// Compute classes for status text
...
// Compute classes for each item in the dropdown
