    ...
    <div class="flex flex-col items-center w-full font-apple select-text">
      ...
      <form @submit.prevent="handleLogin" class="flex flex-col items-center mt-4 w-full" autocomplete="off">
        ...
        <div class="relative w-3/4">
          ...
          >
            <i :class="showPassword ? 'fas fa-eye text-sm' : 'fas fa-eye-slash text-sm'" style="font-size: 1rem;"></i>
          </span>
        </div>
      ...
      <div class="flex items-center mt-4 space-x-2">
        <li @click="goToForgot" :class="{'pointer-events-none text-gray-400': loading, 'text-[#2f66e6]': !loading}" class="list-none text-sm hover:underline cursor-pointer">Can't log in?</li>
        <span class="text-l leading-none">•</span>
        <li @click="goToRegister" :class="{'pointer-events-none text-gray-400': loading, 'text-[#2f66e6]': !loading}" class="list-none text-sm hover:underline cursor-pointer">Create an account</li>
      </div>
      <footer class="w-full flex flex-col items-center mt-8 space-y-2">
        ...
        <ul class="flex items-center justify-center space-x-2">
          <li class="list-none text-xs hover:underline cursor-pointer">Privacy Policy</li>
          <span class="text-l leading-none">•</span>
          <li class="list-none text-xs hover:underline cursor-pointer">User Notice</li>
        </ul>
