  ...
  <div
    ...
    <div class="flex flex-col items-center w-full font-apple select-text">
      ...
      <div class="flex items-center mt-4 space-x-2">
        <li @click="goToForgot" :class="{ 'pointer-events-none text-gray-400': loading, 'text-[#2f66e6]': !loading }"
          class="list-none text-sm hover:underline cursor-pointer">Can't log in?</li>
        <span class="text-l leading-none">•</span>
        <li @click="goToRegister" :class="{ 'pointer-events-none text-gray-400': loading, 'text-[#2f66e6]': !loading }"
          class="list-none text-sm hover:underline cursor-pointer">Create an account</li>
      </div>
