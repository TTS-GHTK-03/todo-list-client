  ...
  <div
    ...
    <div class="flex flex-col items-center w-full font-apple select-text">
      ...
      <form @submit.prevent="handleSubmit" class="flex flex-col items-center mt-4 w-full">
        ...
        <span class="font-apple text-sm font-bold w-3/4 text-left ">{{email}}</span>
        ...
        <div class="relative w-3/4">
          ...
          <span @click="togglePassword(1)"
            ...
            <i :class="showPassword1 ? 'fas fa-eye text-sm' : 'fas fa-eye-slash text-sm'" style="font-size: 1rem;"></i>
          </span>
        </div>
        ...
        <div class="relative w-3/4">
          ...
          <span @click="togglePassword(2)"
            class="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-300"
            style="margin-top: 4px;">
            <i :class="showPassword2 ? 'fas fa-eye text-sm' : 'fas fa-eye-slash text-sm'" style="font-size: 1rem;"></i>
          </span>
        </div>

        <div class="w-3/4 mt-2">
          <span class="text-center text-xs smaller-text">
        ...
        <div v-if="successMessage" class="text-blue-500 text-sm mt-2">{{ successMessage }}</div>
