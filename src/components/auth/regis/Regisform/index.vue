<template>
  ...
  >
    <img
      src="../../../../assets/img/atlassian.png"
      alt="atlassian"
      class="w-3/4 min-w-11 select-none px-0 pt-8 pb-4"
    />
    <div class="flex flex-col items-center w-full font-apple select-text">
      <span
        class="text-gray-800 text-center strong text-base font-semibold flex items-center"
      >
        Email address verified
        <i
          class="fa-solid fa-circle-check px-1 text-xs text-green-600 mt-1"
        ></i>
      </span>
      <span
        class="text-gray-800 text-center strong text-xs font-semibold flex items-center"
      >
      ...
      >
        <span
          class="font-apple text-xs w-3/4 text-left mb-1 font-medium text-gray-500"
          >Email address</span
        >
        ...
        <span
          class="font-apple text-xs w-3/4 text-left mb-1 mt-2 font-medium text-gray-500"
          >User name</span
        >
        <input
          type="text"
        ...
        <span
          class="font-apple text-xs w-3/4 text-left mt-2 font-medium text-gray-500"
      ...
      <footer class="w-full flex flex-col items-center mt-4 space-y-2">
        ...
        <img
          src="../../../../assets/img/atlassian.png"
          alt="atlassian"
          class="max-h-6 select-none grayscale"
        />
...
import {
  useRegisAccountStore,
  useValidateOtpRegisStore,
} from "../../../../stores/authStores/regisStore";
...
export default defineComponent({
  ...
  setup() {
    ...
    const registerKey =
      useValidateOtpRegisStore().registerKey?.toString() || "";
